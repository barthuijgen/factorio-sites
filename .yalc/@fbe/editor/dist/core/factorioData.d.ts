...
export declare function loadData(str: string): void;
export default FD;
...
export declare type CursorBoxType = 'regular' | 'not_allowed' | 'electricity' | 'pair' | 'copy' | 'train_visualization' | 'logistics';
export declare type UtilitySprites = {
    cursor_box: Record<CursorBoxType, CursorBox[]>;
